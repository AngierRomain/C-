...
namespace metier
{
    public class Utilisateur
    {
        ...
        public Utilisateur(String unId, String unNom , String unPrenom  , String unLogin , String unMdp , String uneAdresse , String unCp , String uneVille , DateTime uneDateEmb, String unCodeType)
        {
            s_Id = unId;
            s_Nom = unNom;
            s_Prenom = unPrenom;
