...
namespace M2L_JPO
{
    public partial class frmJPO : Form
    {
        ...
        OleDbConnection maConnex = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;" + @"Data source=..\..\..\M2L_JPO1.accdb");
        OleDbCommand maCommand = new OleDbCommand();
        OleDbDataReader unDataReader;
