...
namespace GSB
{
    public partial class frmComptaListeFiches : Form
    {
        ...
        private void btnNouvelleFiche_Click(object sender, EventArgs e)
        {
            idFicheFraisSelectionne = (int)dgvFiches.CurrentRow.Cells[0].Value;
            frmNouvelleFicheFrais NouvelleFicheFrais = new frmNouvelleFicheFrais();
            NouvelleFicheFrais.Owner = this;
            NouvelleFicheFrais.ShowDialog();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                idFicheFraisSelectionne = (int)dgvFiches.CurrentRow.Cells[0].Value;
            CreationFicheFrais CreationFicheFrais = new CreationFicheFrais();
            CreationFicheFrais.Owner = this;
            CreationFicheFrais.ShowDialog();
        }

        private void frmComptaListeFiches_Load(object sender, EventArgs e)
        {
