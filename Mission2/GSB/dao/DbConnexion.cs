...
namespace dao
{
    ...
    {
        const String SQL_BASEDEDONNEES = "robinf_gsb_final";
        const String SQL_USER = "robinf";
        const String SQL_PASSWORD = "robinf";
        ...
        {
            String chaineConnexion = "Server=" + unServeur + ";Port=" + unPort + ";User=" + SQL_USER + ";Password=" + SQL_PASSWORD + ";Database=" + SQL_BASEDEDONNEES + ";" + OPTION;
