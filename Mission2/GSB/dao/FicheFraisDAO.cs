...
namespace dao
{
    public class FicheFraisDAO
    {
        public static List<FicheFrais> chargerFichesFrais()
        {
            ...
            String uneRequete = "SELECT idFiche, idUtilisateur,  mois, annee, dateCreation, dateCloture , CodeEtat , montantDeclare  FROM FICHEFRAIS";
        ...
        public static List<FicheFrais> chargerFichesFraisUnUtilisateur(String unId)
        {
            List<FicheFrais> uneListeFichesFrais = new List<FicheFrais>();
            String uneRequete = "SELECT IdFiche, IdUtilisateur,  mois, annee, dateCreation, dateCloture , CodeEtat , montantDeclare  FROM FICHEFRAIS WHERE IdUtilisateur ='"+unId+"'";
